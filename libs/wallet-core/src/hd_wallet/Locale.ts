export const subjectMailLowerBalance = '【GS】Exchange Balance Too Small';
export const subjectMailInsufficientBalance = '【GS】Exchange Balance Is Insufficient';
export const subjectPendingTooLong = '【GS】Some withdrawals, deposits, internal transfers are pending too long';
...
Below GS exchange hot wallet is lower than threshold.
...
Below GS exchange hot wallet is lower than amount withdrawal.
Please deposit into this address to make transaction for users.
